...
const OPENPANEL_URL =
  "https://openpanel.dev?utm_source=dnachavez.dev&utm_medium=referral&utm_campaign=footer"

// Not derived from `SITE_INFO.url`: that follows `NEXT_PUBLIC_APP_URL` and
// would read `dnachavez.localhost` in dev.
const SITE_TITLE = "dnachavez.dev"
...
function Separator() {
  return <div className="h-4 w-px self-center bg-border" />
}
